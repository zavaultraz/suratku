...
<div class="row">
    <div class="card p-4">
        <h3 class="text-uppercase">Surat Keluar</h3>
        <h5 class="text">Data Surat Keluar</h5>
        <hr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="gap-2">
                                    ...
                                    <!--  -->
                                    <a  class="btn btn-primary mt-2" href="{{route('keluar.show',$row->id)}}">
                                        <i class="bi bi-eye"></i> View
                                    </a>



                                    <a href="{{route('keluar.edit', $row->id)}}" class="btn btn-warning mt-2">
                                        <i class="bi bi-pencil"></i> Edit
                                    </a>
                                    <!-- button delate with route destroy row > id -->
                                    <form action="{{ route('keluar.destroy', $row->id) }}" method="post" class="d-inline">
                                        @csrf
                                        @method('DELETE')
